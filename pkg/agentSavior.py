...
from pkg.saviorPlan import SaviorPlan
...
class AgentSavior:
    def __init__(self, model, configDict):
        ...
        self.plan = SaviorPlan(model.rows, model.columns, self.prob.goalState, initial, "goal", self.mesh)
    ...
    def deliberate(self):
        ...
        path = self.plan.createPlan(self.victimList.pop())
    ...
    def receiveInformation(self, matrix, result):
        self.plan.setInformation(matrix, result)
        self.victimList = self.plan.getClosestVictim()
